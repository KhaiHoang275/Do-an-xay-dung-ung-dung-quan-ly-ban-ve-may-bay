...
public class NguoiDung { 
    ...
    public void setPhanQuyen(String phan_quyen) { this.phan_quyen = phan_quyen; }
    public String getPhanQuyen() { return phan_quyen; }
    
    public void setTrangThaiTK(TrangThai trangThaiTK) { this.trangThaiTK = trangThaiTK; }
    public TrangThai getTrangThaiTK() { return trangThaiTK; }
}