...
public class HangVeDAO {
    ...
    public ArrayList<HangVe> selectAll() {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                list.add(mapResultSetToHangVe(rs));
            }
    ...
    public HangVe selectById(String maHangVe) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) return mapResultSetToHangVe(rs);
            }
        } catch (Exception e) { e.printStackTrace(); }
        return null;
    }
    ...
    private HangVe mapResultSetToHangVe(ResultSet rs) throws SQLException {
        ...
        if (statusStr != null) {
            try {
                hv.setTrangThai(TrangThaiHangVe.valueOf(statusStr.toUpperCase()));
